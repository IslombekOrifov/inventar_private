    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='auth.group')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('status_member', models.CharField(choices=[('wk', 'Worker'), ('lr', 'Leader'), ('dp', 'Deputy'), ('dr', 'Director'), ('vr', 'Viewer')], max_length=3, verbose_name='User status')),
